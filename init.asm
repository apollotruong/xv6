...
main(void)
{
  ...
  76:	74 c8                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  78:	c7 44 24 04 4d 08 00 	movl   $0x84d,0x4(%esp)
  7f:	00 
  ...
  for(;;){
    ...
    if(pid < 0){
      printf(1, "init: fork failed\n");
  8e:	c7 44 24 04 21 08 00 	movl   $0x821,0x4(%esp)
  95:	00 
  ...
  a9:	e8 94 02 00 00       	call   342 <exit>
    ...
    if(pid == 0){
      exec("sh", argv);
  ae:	c7 44 24 04 d4 0a 00 	movl   $0xad4,0x4(%esp)
  b5:	00 
  b6:	c7 04 24 34 08 00 00 	movl   $0x834,(%esp)
  bd:	e8 b8 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  c2:	c7 44 24 04 37 08 00 	movl   $0x837,0x4(%esp)
  c9:	00 
  ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d1:	e8 ca 03 00 00       	call   4a0 <printf>
      exit(0);
...
main(void)
{
  ...
  f1:	00 
  f2:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
  f9:	e8 8c 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  fe:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 105:	00 
 106:	c7 04 24 06 08 00 00 	movl   $0x806,(%esp)
