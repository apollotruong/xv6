...
main(void)
{
  ...
  20:	0f 88 bc 00 00 00    	js     e2 <main+0xe2>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  ...
  5b:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  5d:	78 2f                	js     8e <main+0x8e>
  5f:	90                   	nop
      printf(1, "init: fork failed\n");
      exit(0);
    }
    if(pid == 0){
  60:	74 4c                	je     ae <main+0xae>
  62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exec("sh", argv);
      printf(1, "init: exec sh failed\n");
      exit(0);
    }
    while((wpid=wait((int*)pid)) >= 0 && wpid != pid)
  68:	89 1c 24             	mov    %ebx,(%esp)
  6b:	e8 da 02 00 00       	call   34a <wait>
  70:	85 c0                	test   %eax,%eax
  72:	78 cc                	js     40 <main+0x40>
  74:	39 d8                	cmp    %ebx,%eax
  76:	74 c8                	je     40 <main+0x40>
      printf(1, "zombie!\n");
  78:	c7 44 24 04 3d 08 00 	movl   $0x83d,0x4(%esp)
  7f:	00 
  80:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  87:	e8 04 04 00 00       	call   490 <printf>
  8c:	eb da                	jmp    68 <main+0x68>
  ...
  for(;;){
    ...
    if(pid < 0){
      printf(1, "init: fork failed\n");
  8e:	c7 44 24 04 11 08 00 	movl   $0x811,0x4(%esp)
  95:	00 
  96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  9d:	e8 ee 03 00 00       	call   490 <printf>
      exit(0);
  a2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  a9:	e8 94 02 00 00       	call   342 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  ae:	c7 44 24 04 c4 0a 00 	movl   $0xac4,0x4(%esp)
  b5:	00 
  b6:	c7 04 24 24 08 00 00 	movl   $0x824,(%esp)
  bd:	e8 b8 02 00 00       	call   37a <exec>
      printf(1, "init: exec sh failed\n");
  c2:	c7 44 24 04 27 08 00 	movl   $0x827,0x4(%esp)
  c9:	00 
  ca:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d1:	e8 ba 03 00 00       	call   490 <printf>
      exit(0);
  d6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  dd:	e8 60 02 00 00       	call   342 <exit>
main(void)
{
  int pid, wpid;
  ...
  if(open("console", O_RDWR) < 0){
    mknod("console", 1, 1);
  e2:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  e9:	00 
  ea:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  f1:	00 
  f2:	c7 04 24 f6 07 00 00 	movl   $0x7f6,(%esp)
  f9:	e8 8c 02 00 00       	call   38a <mknod>
    open("console", O_RDWR);
  fe:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 105:	00 
 106:	c7 04 24 f6 07 00 00 	movl   $0x7f6,(%esp)
 10d:	e8 70 02 00 00       	call   382 <open>
 112:	e9 0f ff ff ff       	jmp    26 <main+0x26>
